...
public class ProductsController(IUnitOfWork unitOfWork) : BaseApiController
{
    ...
    public async Task<ActionResult<IReadOnlyList<string>>> GetGenres()
    {
        ...
        var genres = await unitOfWork.Repository<Product>().ListAsync(spec);
        return Ok(genres);
    } 
    ...
    public async Task<ActionResult<IReadOnlyList<string>>> GetLabels()
    {
        ...
        var labels = await unitOfWork.Repository<Product>().ListAsync(spec);
        return Ok(labels);
    }
    ...
    public async Task<ActionResult<IReadOnlyList<string>>> GetArtists()
    {
        ...
        var artists = await unitOfWork.Repository<Product>().ListAsync(spec);
        return Ok(artists);
    }
